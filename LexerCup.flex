...
/* Palabra reservada article*/
( article ) {lexeme=yytext(); return Article;}

/* Marca el fin del algoritmo*/
( end ) {lexeme=yytext(); return End;}

/* Palabra reservada title */
( title) {lexeme=yytext(); return Title;}

/* Palabra reservada autor */
( author) {lexeme=yytext(); return Author;}

/* Palabra reservada date */
...
( "documentclass" ) {return new Symbol(sym.Documentclass, yychar, yyline, yytext());}
